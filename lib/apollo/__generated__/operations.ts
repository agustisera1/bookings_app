...
export type GetListingsQuery = { listings: Array<{ _id: string, type: string, price: number, title: string, description: string, rating: number | null, availabilityRange: Array<string | null> | null, location: { address: string | null, city: string | null, country: string | null } | null }> | null };
