...
export type GetBookingQuery = { booking: { id: string, created_at: string | null, start_date: string | null, end_date: string | null, guests: number | null, status: BookingStatus | null, status_reason: string | null, total_price: number | null, refund_amount: number | null, cancelled_by: BookingParty | null, cancelled_at: string | null, party: BookingParty | null, host: { id: string, name: string | null } | null, listing: { _id: string, type: string, title: string, price: number, photos: Array<string | null> | null, location: { city: string | null, country: string | null } | null, attributes: { check_in_time: string | null, check_out_time: string | null } | null } | null } | null };

export type GetUserBookingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserBookingsQuery = { guestBookings: Array<{ id: string, created_at: string | null, start_date: string | null, end_date: string | null, status: BookingStatus | null, total_price: number | null, guests: number | null, listing: { _id: string, type: string, title: string, photos: Array<string | null> | null } | null } | null> | null };
